...
//   const mq = new this.Query({}, null, this, this.$__collection);

//   if (typeof conditions === 'function' || typeof projection === 'function' || typeof options === 'function') {
//     throw new TypeError('Model.findOne() no longer accepts a callback');
//   }
...
//   return mq.findOne(conditions).exec();
// };
...
// Model.findOne = async function(conditions, projection, options) {
//   _checkContext(this, 'findOne');
...
//   try {
//     const result = await mq.findOne(conditions).exec();
//     return result;
//   } catch (error) {
//     throw error;
//   }
...
// Model.findOne = async function (conditions, projection, options) {
//   if (typeof conditions === 'function' || typeof projection === 'function' || typeof options === 'function') {
//     throw new Error('Model.findOne() no longer accepts a callback');
//   }
...
//   if (projection) {
//     if (typeof projection === 'string' || typeof projection === 'object') {
//       mq.select(projection);
//     } else {
//       throw new TypeError('Invalid select() argument. Must be string or object.');
//     }
...
//       mq.select(projection);
//     } else {
//       console.log('Invalid projection:', projection);
//       throw new TypeError('Invalid select() argument. Must be string or object.');
//     }
//   }
